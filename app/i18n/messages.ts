...
const en: Dictionary = {
	home: {
		title: "trashmail.space Temporary Email (24h) - Free Temp Mail for OTP & Sign-Ups",
		description:
			"Generate free temporary email (temp mail) instantly on trashmail.space. Use a 24-hour disposable inbox for OTP verification, quick sign-ups, and spam control.",
		keywords:
			"smail, smail temp mail, temporary email, temp mail, disposable email, temporary email generator, 24 hour temporary email, no registration email, otp email, trashmail.space",
