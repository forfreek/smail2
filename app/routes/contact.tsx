...
const SUPPORT_EMAIL = "support@trashmail.space";
...
const CONTACT_COPY: Record<Locale, ContactCopy> = {
	...
	zh: {
		metaTitle: "联系我们 | trashmail.space",
		metaDescription: "通过邮箱联系 trashmail.space 支持团队。",
		tag: "支持",
		title: "联系支持团队",
		description:
	...
	es: {
		metaTitle: "Contacto | trashmail.space",
		metaDescription: "Contacta con soporte de trashmail.space por correo.",
		tag: "Soporte",
	...
	fr: {
		metaTitle: "Contact | trashmail.space",
		metaDescription: "Contacter le support trashmail.space par email.",
		tag: "Support",
	...
	de: {
		metaTitle: "Kontakt | trashmail.space",
		metaDescription: "Kontaktiere den trashmail.space Support per E-Mail.",
		tag: "Support",
	...
	ja: {
		metaTitle: "お問い合わせ | trashmail.space",
		metaDescription: "trashmail.space サポートへの連絡先メール。",
		tag: "サポート",
		title: "サポートへ連絡",
		description:
	...
	ko: {
		metaTitle: "문의하기 | trashmail.space",
		metaDescription: "trashmail.space 지원팀에 이메일로 문의하세요.",
		tag: "지원",
		title: "지원팀 문의",
	...
	ru: {
		metaTitle: "Контакты | trashmail.space",
		metaDescription: "Свяжитесь с поддержкой trashmail.space по email.",
		tag: "Поддержка",
	...
	pt: {
		metaTitle: "Contato | trashmail.space",
		metaDescription: "Entre em contato com o suporte da trashmail.space por email.",
		tag: "Suporte",
	...
	ar: {
		metaTitle: "اتصل بنا | trashmail.space",
		metaDescription: "تواصل مع دعم trashmail.space عبر البريد الإلكتروني.",
		tag: "الدعم",
